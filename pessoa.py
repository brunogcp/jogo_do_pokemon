...
class Pessoa:
    ...
    def escolher_pokemon(self):
        if self.pokemons:
            ...
            print('ERRO: Esse jogador não pussiu nehum Pokemon para ser escolhido')
...
class Player(Pessoa):
    ...
    def escolher_pokemon(self):
        ...
        if self.pokemons:
            ...
            print('Esse jogador não pussui nehum Pokemon para ser escolhido')
    ...
    def explorar(self):
        if random.random() <= 0.3:
            ...
            escolha = input('Deseja capaturar pokemon? (s/n): ')
            if escolha == 's':
            ...
            print('Esssa exploração não deu em nada')
